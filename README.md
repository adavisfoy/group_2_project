...
**Multiple Linear Regression**
   ...
   - A Multiple Linear Regression Supervised Learning model is appropriate due to the following: 
     ...
     - Linear regression models work well for modeling the relationships between a continuous, dependent variable 'y,' and two or more predictors 'X.'
     - Multiple linear regression will allow us to utilize two or more independent variables to predict the outcome of a 
